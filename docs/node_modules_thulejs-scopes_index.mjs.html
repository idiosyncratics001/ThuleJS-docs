...
<head>
    ...
    <meta charset="utf-8">
    <title>node_modules/thulejs-scopes/index.mjs - ThuleJS</title>
...
<div id="main">
    ...
    <h1 class="page-title">node_modules/thulejs-scopes/index.mjs</h1>
...
export default{
     ...
     */
    getScopes(...args){
        return scopes._scopes.getScope(...args);
    },
