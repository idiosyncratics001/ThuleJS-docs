...
<head>
    ...
    <meta charset="utf-8">
    <title>node_modules/thulejs-env/src/index.mjs - ThuleJS</title>
...
/**
 * @description handles errors in thulejs-env
...
/**
 * @description retrieves content from file and processes it into a key:value object
...
export default class _env {
    ...
    /** @description check-in of your env scope (cannot be checked out). */
    static setCheckIn() {
    ...
    /** @description set use-strict on all modules. */
    static setStrict(){
    ...
    /** @description check-in of your process.env scope (cannot be undone). */
    ...
    /** @description If node is not started with this as an argument it can still be applied to worker &amp; child-processes. */
    ...
    /** @description check-in of your global scope (cannot be undone). */
    static setGlobal() {
